  ...
  return (
    <>
      ...
      <aside
        ...
        style={{ boxShadow: isOpen ? "-20px 0 60px -15px rgba(0,0,0,0.1)" : "none" }}
      >
        <div className="flex items-center justify-between p-6 border-b border-border/50">
          <a href="#inicio" className="flex items-center gap-3" onClick={() => setIsOpen(false)}>
            ...
            <span className="font-semibold text-sm text-foreground font-serif tracking-wide">Integral</span>
          </a>
